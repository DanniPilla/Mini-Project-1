const jFashionDictionary = [
  {
    ...
    exampleUsage:
      "Her outfit is so kawaii with its pastel colors and playful accessories!",
    relatedStyles: [],
  },
  {
    id: 2,
    ...
    exampleUsage:
      "She called herself an ita because she loves to mix so many patterns and colors.",
    relatedStyles: [],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    exampleUsage:
      "Her blue letter fashion made her stand out with its eclectic mix of styles.",
    relatedStyles: [],
  },
  {
    id: 7,
    ...
    exampleUsage:
      "She wore an otome outfit with a floral dress and a cute parasol.",
    relatedStyles: [],
  },
  {
    id: 8,
  ...
  },
  {
    ...
    exampleUsage:
      "The zoku of Harajuku are known for their eclectic mix of styles.",
    relatedStyles: [],
  },
  {
    id: 15,
  ...
  },
  {
    ...
    exampleUsage:
      "He spent months preparing for his cosplay of his favorite anime character.",
    relatedStyles: [],
  },
  {
    id: 20,
  ...
  },
  {
    ...
    exampleUsage:
      "Kawaii culture is deeply rooted in Japanese society, affecting various aspects of life.",
    relatedStyles: [],
  },
  {
    id: 22,
    ...
    exampleUsage:
      "Street fashion in Tokyo is known for its creativity and boldness.",
    relatedStyles: [],
  },
  {
    id: 23,
  ...
  },
  {
    ...
    exampleUsage:
      "She's a true fashionista, always wearing the newest collections.",
    relatedStyles: [],
  },
  {
    id: 25,
  ...
  },
  {
    ...
    exampleUsage:
      "The Kawaii Monster Cafe is a must-visit for any kawaii fashion lover.",
    relatedStyles: [],
  },
  {
    id: 30,
    ...
    exampleUsage:
      "His otaku fashion choices reflect his love for his favorite series.",
    relatedStyles: [],
  },
];
...
function displayWords() {
  ...
  wordList.innerHTML = ""; // Clear previous posts

  jFashionDictionary.forEach((entry) => {
    const clone = template.content.cloneNode(true);
    clone.querySelector(".dictionary-term").innerText = entry.term;
    clone.querySelector(".dictionary-definition").innerText = entry.definition;
    clone.querySelector(".dictionary-example-content").innerText =
      entry.exampleUsage;
...
function filterByWord(word) {
  const filteredWords = jFashionDictionary.filter((entry) =>
    entry.term.toLowerCase().includes(word.toLowerCase())
  );
